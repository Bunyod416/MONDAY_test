...
export const questions: Question[] = [
  ...
  },
  {
    ...
    options: ["input", "field", "enter", "data"],
    answer: "A",
  ...
  },
  {
    ...
    options: ["def", "func", "method", "function"],
    answer: "D",
  ...
  },
  {
    ...
    options: [
      "document.getElement('sarlavha')",
      "document.getElementById('sarlavha')",
      "document.selectId('sarlavha')",
      "document.findId('sarlavha')",
    ],
    answer: "B",
  ...
  // ─── JS Code ─────────────────────────────────────────────────────────────────
  {
    ...
    topic: "O'zgaruvchilar",
    question:
      "'Jasur' qiymatini saqlaydigan `ism` nomli const o'zgaruvchi e'lon qiling va konsolga chiqaring.",
